...
<template>
  <div class="salary">
    ...
    >
      ...
      <div class="newbeater">
        <div class="somebte" @click="closeClick(item)" :class="item.index == someIndex ? 'active' : ''" v-for="item in somedatas" :key="item.id">{{item.name}}</div>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      //工资
      salarywage: "5000",
      imageUrl: "../assets/images/backcolor.jpg",
      dataondter: [
        {
          name: "哈哈哈",
          number: "333333",
